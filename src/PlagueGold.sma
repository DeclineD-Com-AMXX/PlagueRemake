...
new const   szVaultName[] = "currency_gold_save";
new         vault;
...
{
    fwdChangedAmmo = CreateMultiForward("Plague_SetUserGold", ET_CONTINUE, FP_CELL, FP_CELL);
    fwdChangedAmmoPost = CreateMultiForward("Plague_SetUserGold_Post", ET_IGNORE, FP_CELL, FP_CELL);
}

public plugin_natives()
{
    register_native("pr_set_user_gold", "Native_SetPacks");
    register_native("pr_get_user_gold", "Native_GetPacks");
}
...
public plugin_init()
{
    register_plugin("[Plague] Currency: Model (Gold)", "v1.0", "DeclineD");

    register_concmd("amx_gold", "cmdAmmo", ADMIN_PASSWORD, "Usage: amx_gold <name/all> <set/add/take> <amount>");
    ...
    cOn = register_cvar("pr_currency_gold_on", "1");
    cSave = register_cvar("pr_currency_gold_save", "1");
    cSaveType = register_cvar("pr_currency_gold_save_type", "0");
    cSaveCount = register_cvar("pr_currency_gold_save_max", "20000");
    cSaveCountVip = register_cvar("pr_currency_gold_save_max_vip", "50000");
    cKillReward = register_cvar("pr_currency_gold_kill_reward", "5");
    cKillRewardVip = register_cvar("pr_currency_gold_kill_reward_vip", "5");
    cInfectReward = register_cvar("pr_currency_gold_infect_reward", "3");
    cInfectRewardVip = register_cvar("pr_currency_gold_infect_reward_vip", "3");
    cKillCount = register_cvar("pr_currency_gold_kill_to_reward", "1");
    cKillCountVip = register_cvar("pr_currency_gold_kill_to_reward_vip", "1");
    cInfectCount = register_cvar("pr_currency_gold_infect_to_reward", "1");
    cInfectCountVip = register_cvar("pr_currency_gold_infect_to_reward_vip", "1");
    cDamageReward = register_cvar("pr_currency_gold_damage_reward", "2");
    cDamageRewardVip = register_cvar("pr_currency_gold_damage_reward_vip", "2");
    cDamageCount = register_cvar("pr_currency_gold_damage_to_reward", "2.0");
    cDamageCountVip = register_cvar("pr_currency_gold_damage_to_reward_vip", "2.0");
...
public cmdAmmo(id, level, cid)
{
    ...
    client_print_color(id, 0, "^4[ZP] ^3Admin ^4%n ^1%s ^4%s ^3%i ^4Gold^1.", id, (iMethod == 0 ? "set" : (iMethod == 1 ? "gave" : "took")), (player > 0 ? fmt("%n", player) : "Everyone"), iAmount);
